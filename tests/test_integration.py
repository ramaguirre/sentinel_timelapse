...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_item1.id = "S2A_MSIL2A_20230115T100000_N0509_R122_T19HFA_20230115T120000"
        self.mock_item1.properties = {'datetime': '2023-01-15T10:00:00Z'}
        
        self.mock_item2 = Mock()
        self.mock_item2.id = "S2A_MSIL2A_20230120T100000_N0509_R122_T19HFA_20230120T120000"
            ...
            with patch('sentinel_timelapse.main.filter_items_by_geometry') as mock_filter:
                with patch('sentinel_timelapse.main.search_stac_items') as mock_search:
                    with patch('sentinel_timelapse.main.bounds_to_geom_wgs84') as mock_bounds:
                        # Setup mocks
                        mock_bounds.return_value = {'type': 'Polygon', 'coordinates': []}
                        ...
                        self.assertTrue(os.path.exists(os.path.join(self.temp_dir, 'visual')))
                        self.assertTrue(os.path.exists(os.path.join(self.temp_dir, 'B04')))
