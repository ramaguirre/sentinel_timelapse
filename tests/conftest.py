...
def test_dates():
    """Test date range."""
    return {"start_date": "2023-01-01", "end_date": "2023-01-31"}
...
def mock_signed_item():
    ...
    signed_item.assets = {"visual": mock_asset, "B04": mock_asset, "SCL": mock_asset}
    return signed_item
...
def mock_cloud_data():
    ...
    return {"low": low_cloud, "high": high_cloud}
