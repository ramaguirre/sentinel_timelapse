...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_bounds_to_geom_wgs84_string_crs(self):
        ...
        geom2 = bounds_to_geom_wgs84(*self.bounds, input_crs='+proj=utm +zone=19 +south')
        self.assertIsNotNone(geom2)
    ...
    def test_filter_items_by_geometry_no_intersection(self):
        ...
        mock_item2 = Mock()
        mock_item2.geometry = mapping(box(1000000, 1000000, 1000001, 1000001))  # Very far
    ...
    def test_clipped_asset_bounds_completely_outside(self, mock_rasterio_open, mock_sign):
        ...
        result = clipped_asset(
            Mock(), 100000, 100000, 101000, 101000,  # Far outside
            asset_name='visual'
        )
    ...
    @patch('sentinel_timelapse.main.filter_items_by_geometry')
    @patch('sentinel_timelapse.main.clipped_asset')
    def test_download_images_no_cloud_filtering(self, mock_clip, mock_filter, mock_search):
        ...
        scl_calls = [call for call in mock_clip.call_args_list 
    ...
    def test_download_images_single_asset_string(self):
        ...
        with patch('sentinel_timelapse.main.search_stac_items') as mock_search:
            with patch('sentinel_timelapse.main.filter_items_by_geometry') as mock_filter:
