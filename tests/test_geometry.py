...
class TestGeometry(unittest.TestCase):
    ...
    def test_bounds_to_geom_wgs84_shapely_format(self):
        ...
        result = bounds_to_geom_wgs84(
            *self.test_bounds_utm, input_crs=24879, output_format="shapely"
        )
    ...
    def test_bounds_to_geom_wgs84_json_format(self):
        ...
        result = bounds_to_geom_wgs84(
            *self.test_bounds_utm, input_crs=24879, output_format="json"
        )
    ...
    def test_bounds_to_geom_wgs84_different_crs(self):
        ...
        result = bounds_to_geom_wgs84(
            *wgs84_bounds, input_crs=4326, output_format="shapely"
        )
    ...
    def test_bounds_to_geom_wgs84_string_crs(self):
        ...
        result = bounds_to_geom_wgs84(
            *self.test_bounds_utm, input_crs="EPSG:24879", output_format="shapely"
        )
    ...
    def test_bounds_to_geom_wgs84_invalid_crs(self):
        ...
        with self.assertRaises(Exception):
            bounds_to_geom_wgs84(
                *self.test_bounds_utm, input_crs=999999, output_format="shapely"
            )
    ...
    def test_bounds_to_geom_wgs84_invalid_format(self):
        ...
        result = bounds_to_geom_wgs84(
            *self.test_bounds_utm, input_crs=24879, output_format="invalid_format"
        )
